...
class RfqDataSchema(BaseModel):
    ...
    technical_specifications: Optional[str] = Field(None, description="technical specifications of the product in a list")
    quality_requirements: Optional[str] = Field(None, description="quality requirements for the product in a list")
    required_certifications: Optional[str] = Field(None, description="certifications required for the product in a list")